...
def run_rsdChisquare(array=None,chr_name=None,cutoff=None,windowsize=None,chrlength=None):
	start=array[0,0]
...
def countSnv(inputfile=None,chr_name=None,sample_num=None,chrlength=None,windowsize=None):
	'''
...
def main():
	...
	out_dir=upperpath+'/02caculatersd'
